// Implementation file for Book 0a Unit 3

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0a-unit3-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 3
const vocabularyLessonPlan: LessonPlan = {
  id: `book0a-unit3-vocabulary-lesson`,
  title: `VISUAL 0A Unit 3 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0a-unit3-activities-lesson`,
  title: `VISUAL 0A Unit 3 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0aUnit3LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0aUnit3Resources = (): TeacherResource[] => resources;
