// Implementation file for Book 0c Unit 12

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0c-unit12-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 12
const vocabularyLessonPlan: LessonPlan = {
  id: `book0c-unit12-vocabulary-lesson`,
  title: `VISUAL 0C Unit 12 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0c-unit12-activities-lesson`,
  title: `VISUAL 0C Unit 12 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0cUnit12LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0cUnit12Resources = (): TeacherResource[] => resources;
