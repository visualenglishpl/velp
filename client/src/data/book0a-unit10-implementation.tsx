// Implementation file for Book 0a Unit 10

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0a-unit10-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 10
const vocabularyLessonPlan: LessonPlan = {
  id: `book0a-unit10-vocabulary-lesson`,
  title: `VISUAL 0A Unit 10 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0a-unit10-activities-lesson`,
  title: `VISUAL 0A Unit 10 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0aUnit10LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0aUnit10Resources = (): TeacherResource[] => resources;
