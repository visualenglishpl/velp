// Implementation file for Book 0c Unit 2

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0c-unit2-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 2
const vocabularyLessonPlan: LessonPlan = {
  id: `book0c-unit2-vocabulary-lesson`,
  title: `VISUAL 0C Unit 2 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0c-unit2-activities-lesson`,
  title: `VISUAL 0C Unit 2 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0cUnit2LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0cUnit2Resources = (): TeacherResource[] => resources;
