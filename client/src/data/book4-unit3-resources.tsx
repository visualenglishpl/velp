...
export const games: TeacherResource[] = [
  {
    id: `book4-unit3-game-1`,
    bookId: '4',
    unitId: '3',
    title: 'VISUAL 4 Unit 3 Game 1',
    resourceType: 'game',
    provider: 'Wordwall',
  ...
  {
    id: `book4-unit3-game-2`,
    bookId: '4',
    unitId: '3',
    title: 'VISUAL 4 Unit 3 Game 2',
    resourceType: 'game',
    provider: 'Wordwall',
    sourceUrl: 'https://wordwall.net/resource/placeholder',
    embedCode: '<iframe style="max-width:100%" src="https://wordwall.net/embed/placeholder" width="500" height="380" frameborder="0" allowfullscreen></iframe>'
...
export const book4Unit3Resources = resources;
