// Implementation file for Book 0c Unit 7

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0c-unit7-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 7
const vocabularyLessonPlan: LessonPlan = {
  id: `book0c-unit7-vocabulary-lesson`,
  title: `VISUAL 0C Unit 7 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0c-unit7-activities-lesson`,
  title: `VISUAL 0C Unit 7 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0cUnit7LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0cUnit7Resources = (): TeacherResource[] => resources;
