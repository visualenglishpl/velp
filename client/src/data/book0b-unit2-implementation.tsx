// Implementation file for Book 0b Unit 2

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0b-unit2-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 2
const vocabularyLessonPlan: LessonPlan = {
  id: `book0b-unit2-vocabulary-lesson`,
  title: `VISUAL 0B Unit 2 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0b-unit2-activities-lesson`,
  title: `VISUAL 0B Unit 2 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0bUnit2LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0bUnit2Resources = (): TeacherResource[] => resources;
