// Implementation file for Book 0a Unit 15

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0a-unit15-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 15
const vocabularyLessonPlan: LessonPlan = {
  id: `book0a-unit15-vocabulary-lesson`,
  title: `VISUAL 0A Unit 15 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0a-unit15-activities-lesson`,
  title: `VISUAL 0A Unit 15 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0aUnit15LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0aUnit15Resources = (): TeacherResource[] => resources;
