 ...
 * Resources gathered from attached assets
 */

// Define Unit 11 resources for Get Well Soon
const book3Unit11Resources: TeacherResource[] = [
  // Game Resources
  {
    id: 'book3-unit11-game-1',
    bookId: '3',
    unitId: '11',
    title: 'VISUAL 3 - UNIT 11 - GET WELL SOON - ANAGRAM',
    resourceType: 'game',
    provider: 'Wordwall',
  ...
  {
    id: 'book3-unit11-game-2',
    bookId: '3',
    unitId: '11',
    title: 'VISUAL 3 - UNIT 11 - GET WELL SOON (1)',
    resourceType: 'game',
    provider: 'Wordwall',
  ...
  {
    id: 'book3-unit11-game-3',
    bookId: '3',
    unitId: '11',
    title: 'VISUAL 3 - UNIT 11 - GET WELL SOON (2)',
    resourceType: 'game',
    provider: 'Wordwall',
  ...
  {
    id: 'book3-unit11-game-4',
    bookId: '3',
    unitId: '11',
    title: 'VISUAL 3 - UNIT 11 - GET WELL SOON (3)',
    resourceType: 'game',
    provider: 'Wordwall',
    sourceUrl: 'https://wordwall.net/resource/99a4405b524642129e645b4bc7d249b8',
    embedCode: '<iframe style="max-width:100%" src="https://wordwall.net/embed/99a4405b524642129e645b4bc7d249b8?themeId=1&templateId=3&fontStackId=0" width="500" height="380" frameborder="0" allowfullscreen></iframe>',
    content: {
      type: 'wordwall',
  ...
  {
    id: 'book3-unit11-game-5',
    bookId: '3',
    unitId: '11',
    title: 'VISUAL 3 - UNIT 11 - GET WELL SOON - PEOPLE AND PLACES',
    resourceType: 'game',
    provider: 'Wordwall',
    sourceUrl: 'https://wordwall.net/resource/fa6e068d9f8445ceabfa1efedaf6b54b',
    embedCode: '<iframe style="max-width:100%" src="https://wordwall.net/embed/fa6e068d9f8445ceabfa1efedaf6b54b?themeId=1&templateId=3&fontStackId=0" width="500" height="380" frameborder="0" allowfullscreen></iframe>',
    content: {
      type: 'wordwall',
  ...
  {
    id: 'book3-unit11-game-6',
    bookId: '3',
    unitId: '11',
    title: 'VISUAL 3 - UNIT 11 - REMEDIES (1)',
    resourceType: 'game',
    provider: 'Wordwall',
  ...
  {
    id: 'book3-unit11-game-7',
    bookId: '3',
    unitId: '11',
    title: 'VISUAL 3 - UNIT 11 - REMEDIES (2)',
    resourceType: 'game',
    provider: 'Wordwall',
    sourceUrl: 'https://wordwall.net/resource/dd88b65b3b364d908619f07474da9e78',
    embedCode: '<iframe style="max-width:100%" src="https://wordwall.net/embed/dd88b65b3b364d908619f07474da9e78?themeId=1&templateId=3&fontStackId=0" width="500" height="380" frameborder="0" allowfullscreen></iframe>',
    content: {
      type: 'wordwall',
