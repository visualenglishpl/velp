...
/**
 * This file contains common resources for Book 3
 */

// Unit titles for Book 3
...
export function generateBook3UnitResources(bookId: string, unitId: string): TeacherResource[] {
  const unitTitle = BOOK3_UNIT_TITLES[unitId] || `Unit ${unitId}`;

  return [
    {
      id: `book3-unit${unitId}-default-video`,
      bookId,
      unitId,
    ...
    {
      id: `book3-unit${unitId}-default-game`,
      bookId,
      unitId,
