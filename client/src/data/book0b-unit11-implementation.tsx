// Implementation file for Book 0b Unit 11

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0b-unit11-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 11
const vocabularyLessonPlan: LessonPlan = {
  id: `book0b-unit11-vocabulary-lesson`,
  title: `VISUAL 0B Unit 11 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0b-unit11-activities-lesson`,
  title: `VISUAL 0B Unit 11 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0bUnit11LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0bUnit11Resources = (): TeacherResource[] => resources;
