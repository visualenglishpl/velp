...
export const book3Unit18Resources: TeacherResource[] = [
  // Game Resources
  {
    ...
    bookId: '3',
    unitId: '18',
    title: 'VISUAL 3 - UNIT 18 - MOVIES - FILMS - WORDWALL (1)',
    resourceType: 'game',
    provider: 'Wordwall',
  ...
  {
    id: 'book3-unit18-game-2',
    bookId: '3',
    unitId: '18',
    title: 'VISUAL 3 - UNIT 18 - MOVIES - FILMS - WORDWALL (2)',
    resourceType: 'game',
    provider: 'Wordwall',
  ...
  {
    id: 'book3-unit18-game-3',
    bookId: '3',
    unitId: '18',
    title: 'VISUAL 3 - UNIT 18 - MOVIES - FILMS - WORDWALL (3)',
    resourceType: 'game',
    provider: 'Wordwall',
