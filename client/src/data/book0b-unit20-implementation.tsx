// Implementation file for Book 0b Unit 20

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0b-unit20-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 20
const vocabularyLessonPlan: LessonPlan = {
  id: `book0b-unit20-vocabulary-lesson`,
  title: `VISUAL 0B Unit 20 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0b-unit20-activities-lesson`,
  title: `VISUAL 0B Unit 20 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0bUnit20LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0bUnit20Resources = (): TeacherResource[] => resources;
