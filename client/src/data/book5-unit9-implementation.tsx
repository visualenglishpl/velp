// This file imports and exports the resources and lesson plans for Book 5, Unit 9

import { book5Unit9Resources, emotionsVocabularyLessonPlan, respondingEmotionsLessonPlan } from './book5-unit9-resources';
...
export const getBook5Unit9LessonPlans = (): LessonPlan[] => {
  return [
    emotionsVocabularyLessonPlan,
    respondingEmotionsLessonPlan
  ];
};

// Function to get resources for this unit
export const getBook5Unit9Resources = (bookId: string, unitId: string): TeacherResource[] => {
  return book5Unit9Resources.map(resource => ({
    id: `book5-unit9-${resource.title.toLowerCase().replace(/\s+/g, '-')}`,
    bookId,
    unitId,
    ...resource
  }));
...
export const unitResources = book5Unit9Resources;
