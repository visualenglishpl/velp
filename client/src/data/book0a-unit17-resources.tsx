...
/**
 * Resources for Book 0a Unit 17
 */

// Videos for Unit 17
export const videos: TeacherResource[] = [
  {
    id: `book0a-unit17-video-1`,
    bookId: '0a',
    unitId: '17',
    title: 'VISUAL 0A Unit 17 Video 1',
    resourceType: 'video',
    provider: 'YouTube',
  ...
  {
    id: `book0a-unit17-video-2`,
    bookId: '0a',
    unitId: '17',
    title: 'VISUAL 0A Unit 17 Video 2',
    resourceType: 'video',
    provider: 'YouTube',
    sourceUrl: 'https://www.youtube.com/embed/placeholder',
    embedCode: '<iframe width="560" height="315" src="https://www.youtube.com/embed/placeholder" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
...
export const games: TeacherResource[] = [
  {
    id: `book0a-unit17-game-1`,
    bookId: '0a',
    unitId: '17',
    title: 'VISUAL 0A Unit 17 Game 1',
    resourceType: 'game',
    provider: 'Wordwall',
  ...
  {
    id: `book0a-unit17-game-2`,
    bookId: '0a',
    unitId: '17',
    title: 'VISUAL 0A Unit 17 Game 2',
    resourceType: 'game',
    provider: 'Wordwall',
    sourceUrl: 'https://wordwall.net/resource/placeholder',
    embedCode: '<iframe style="max-width:100%" src="https://wordwall.net/embed/placeholder" width="500" height="380" frameborder="0" allowfullscreen></iframe>'
...
export const book0aUnit17Resources = resources;
