// Implementation file for Book 0c Unit 1

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0c-unit1-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 1
const vocabularyLessonPlan: LessonPlan = {
  id: `book0c-unit1-vocabulary-lesson`,
  title: `VISUAL 0C Unit 1 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0c-unit1-activities-lesson`,
  title: `VISUAL 0C Unit 1 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0cUnit1LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0cUnit1Resources = (): TeacherResource[] => resources;
