// Implementation file for Book 0a Unit 18

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0a-unit18-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 18
const vocabularyLessonPlan: LessonPlan = {
  id: `book0a-unit18-vocabulary-lesson`,
  title: `VISUAL 0A Unit 18 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0a-unit18-activities-lesson`,
  title: `VISUAL 0A Unit 18 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0aUnit18LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0aUnit18Resources = (): TeacherResource[] => resources;
