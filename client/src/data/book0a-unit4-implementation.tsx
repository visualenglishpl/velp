// Implementation file for Book 0a Unit 4

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0a-unit4-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 4
const vocabularyLessonPlan: LessonPlan = {
  id: `book0a-unit4-vocabulary-lesson`,
  title: `VISUAL 0A Unit 4 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0a-unit4-activities-lesson`,
  title: `VISUAL 0A Unit 4 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0aUnit4LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0aUnit4Resources = (): TeacherResource[] => resources;
