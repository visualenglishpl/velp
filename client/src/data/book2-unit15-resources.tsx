/**
 * Visual English Book 2, Unit 15: AT THE FARM
...
export const book2Unit15VideoResources: TeacherResource[] = [
  ...
  },
  {
    ...
    resourceType: 'video',
    provider: 'YouTube',
    sourceUrl: 'https://www.youtube.com/watch?v=DnDMUoo1mjU',
  ...
  },
  {
    ...
    embedCode: `<iframe width="560" height="315" src="https://www.youtube.com/embed/acZfmL4SUIc?si=8dbnc2f49TQVBbT1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`
  }
];
...
export const book2Unit15GameResources: TeacherResource[] = [
  {
    ...
    resourceType: 'game',
    provider: 'Wordwall',
    sourceUrl: 'https://wordwall.net/resource/f715845f760c4731ac851d1b8ca512a4',
  ...
  },
  {
    ...
    resourceType: 'game',
    provider: 'Wordwall',
    sourceUrl: 'https://wordwall.net/resource/c42531f633444f29a6cb24bcc2f30ade',
  ...
  },
  {
    ...
    resourceType: 'game',
    provider: 'Wordwall',
    sourceUrl: 'https://wordwall.net/resource/5e1db204ee9b4460a29bde6266ae5e43',
  ...
  },
  {
    ...
    resourceType: 'game',
    provider: 'Wordwall',
    sourceUrl: 'https://wordwall.net/resource/c7cbc1fe585e4ecca7c4d55f3380717b',
  ...
  },
  {
    ...
    resourceType: 'game',
    provider: 'Wordwall',
    sourceUrl: 'https://wordwall.net/resource/ef130d13ee8f4944a23a7fa481ad0e48',
    embedCode: `<iframe style="max-width:100%" src="https://wordwall.net/embed/ef130d13ee8f4944a23a7fa481ad0e48?themeId=2&templateId=25&fontStackId=0" width="500" height="380" frameborder="0" allowfullscreen></iframe>`
  }
];

// Combined resources
export const book2Unit15Resources: TeacherResource[] = [
  ...book2Unit15VideoResources,
  ...book2Unit15GameResources
];

// Export a function to get all resources for this unit
export const getBook2Unit15Resources = () => book2Unit15Resources;

export default book2Unit15Resources;