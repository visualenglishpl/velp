// Implementation file for Book 0a Unit 6

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0a-unit6-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 6
const vocabularyLessonPlan: LessonPlan = {
  id: `book0a-unit6-vocabulary-lesson`,
  title: `VISUAL 0A Unit 6 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0a-unit6-activities-lesson`,
  title: `VISUAL 0A Unit 6 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0aUnit6LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0aUnit6Resources = (): TeacherResource[] => resources;
