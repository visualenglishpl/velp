...
/**
 * This file contains common resources for Book 7
 */

// Unit titles for Book 7
export const BOOK7_TITLE = 'VISUAL 7';
...
export function generateBook7UnitResources(bookId: string, unitId: string): TeacherResource[] {
  const unitTitle = BOOK7_UNIT_TITLES[unitId] || `Unit ${unitId}`;

  return [
    {
      id: `book7-unit${unitId}-default-video`,
      bookId,
      unitId,
    ...
    {
      id: `book7-unit${unitId}-default-game`,
      bookId,
      unitId,
