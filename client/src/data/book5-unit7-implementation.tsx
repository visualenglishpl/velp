// This file imports and exports the resources and lesson plans for Book 5, Unit 7

import { book5Unit7Resources, illnessVocabularyLessonPlan, remediesHealthAdviceLessonPlan } from './book5-unit7-resources';
...
export const getBook5Unit7LessonPlans = (): LessonPlan[] => {
  return [
    illnessVocabularyLessonPlan,
    remediesHealthAdviceLessonPlan
  ];
};

// Function to get resources for this unit
export const getBook5Unit7Resources = (bookId: string, unitId: string): TeacherResource[] => {
  return book5Unit7Resources.map(resource => ({
    id: `book5-unit7-${resource.title.toLowerCase().replace(/\s+/g, '-')}`,
    bookId,
    unitId,
    ...resource
  }));
...
export const unitResources = book5Unit7Resources;
