// Implementation file for Book 0c Unit 3

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0c-unit3-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 3
const vocabularyLessonPlan: LessonPlan = {
  id: `book0c-unit3-vocabulary-lesson`,
  title: `VISUAL 0C Unit 3 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0c-unit3-activities-lesson`,
  title: `VISUAL 0C Unit 3 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0cUnit3LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0cUnit3Resources = (): TeacherResource[] => resources;
