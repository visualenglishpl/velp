// Implementation file for Book 0c Unit 16

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0c-unit16-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 16
const vocabularyLessonPlan: LessonPlan = {
  id: `book0c-unit16-vocabulary-lesson`,
  title: `VISUAL 0C Unit 16 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0c-unit16-activities-lesson`,
  title: `VISUAL 0C Unit 16 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0cUnit16LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0cUnit16Resources = (): TeacherResource[] => resources;
