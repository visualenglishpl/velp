...
/**
 * This file contains common resources for Book 0b
 */

// Unit titles for Book 0b
export const BOOK0B_TITLE = 'VISUAL 0B';
export const BOOK0B_UNIT_TITLES: Record<string, string> = {
  '1': 'Unit 1',
  '2': 'Unit 2',
  '3': 'Unit 3',
  '4': 'Unit 4',
...
export function generateBook0bUnitResources(bookId: string, unitId: string): TeacherResource[] {
  const unitTitle = BOOK0B_UNIT_TITLES[unitId] || `Unit ${unitId}`;

  return [
    {
      id: `book0b-unit${unitId}-default-video`,
      bookId,
      unitId,
    ...
    {
      id: `book0b-unit${unitId}-default-game`,
      bookId,
      unitId,
