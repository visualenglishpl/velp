// Implementation file for Book 0c Unit 19

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0c-unit19-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 19
const vocabularyLessonPlan: LessonPlan = {
  id: `book0c-unit19-vocabulary-lesson`,
  title: `VISUAL 0C Unit 19 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0c-unit19-activities-lesson`,
  title: `VISUAL 0C Unit 19 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0cUnit19LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0cUnit19Resources = (): TeacherResource[] => resources;
