...
export const book3Unit7Resources: TeacherResource[] = [
  // Video Resources
  {
  ...
  {
    id: `book3-unit${unitNumber}-video-5`,
    bookId: '3',
    unitId: unitNumber,
  ...
  {
    id: `book3-unit${unitNumber}-video-6`,
    bookId: '3',
    unitId: unitNumber,
  ...
  {
    id: `book3-unit${unitNumber}-video-7`,
    bookId: '3',
    unitId: unitNumber,
  ...
  {
    id: `book3-unit${unitNumber}-video-8`,
    bookId: '3',
    unitId: unitNumber,
    title: `${BOOK3_TITLE} - UNIT ${unitNumber} - ${unitTitle} - Mr. President and Aliens`,
    resourceType: 'video',
    provider: 'YouTube',
  ...
  {
    id: `book3-unit${unitNumber}-video-9`,
    bookId: '3',
    unitId: unitNumber,
  ...
  },
  {
    ...
    bookId: '3',
    unitId: unitNumber,
    title: `${BOOK3_TITLE} - UNIT ${unitNumber} - ${unitTitle} - WORDWALL - PLANETS LABEL (3)`,
    resourceType: 'game',
    provider: 'Wordwall',
...
export default book3Unit7Resources;