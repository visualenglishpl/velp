// Implementation file for Book 0c Unit 9

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0c-unit9-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 9
const vocabularyLessonPlan: LessonPlan = {
  id: `book0c-unit9-vocabulary-lesson`,
  title: `VISUAL 0C Unit 9 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0c-unit9-activities-lesson`,
  title: `VISUAL 0C Unit 9 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0cUnit9LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0cUnit9Resources = (): TeacherResource[] => resources;
