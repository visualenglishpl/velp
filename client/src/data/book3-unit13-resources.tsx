...
/**
 * Resources for Book 3 Unit 13
 */

// Videos for Unit 13
export const videos: TeacherResource[] = [
  {
    id: `book3-unit13-video-1`,
    bookId: '3',
    unitId: '13',
    title: 'VISUAL 3 Unit 13 Video 1',
    resourceType: 'video',
    provider: 'YouTube',
  ...
  {
    id: `book3-unit13-video-2`,
    bookId: '3',
    unitId: '13',
    title: 'VISUAL 3 Unit 13 Video 2',
    resourceType: 'video',
    provider: 'YouTube',
    sourceUrl: 'https://www.youtube.com/embed/placeholder',
    embedCode: '<iframe width="560" height="315" src="https://www.youtube.com/embed/placeholder" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
...
export const games: TeacherResource[] = [
  {
    id: `book3-unit13-game-1`,
    bookId: '3',
    unitId: '13',
    title: 'VISUAL 3 Unit 13 Game 1',
    resourceType: 'game',
    provider: 'Wordwall',
  ...
  {
    id: `book3-unit13-game-2`,
    bookId: '3',
    unitId: '13',
    title: 'VISUAL 3 Unit 13 Game 2',
    resourceType: 'game',
    provider: 'Wordwall',
    sourceUrl: 'https://wordwall.net/resource/placeholder',
    embedCode: '<iframe style="max-width:100%" src="https://wordwall.net/embed/placeholder" width="500" height="380" frameborder="0" allowfullscreen></iframe>'
...
export const book3Unit13Resources = resources;
