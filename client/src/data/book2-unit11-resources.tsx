...
export const book2Unit11VideoResources: TeacherResource[] = [
  {
    id: 'book2-unit11-video1',
    bookId: '2',
    unitId: '11',
    title: 'New House for Kids - WATTS ENGLISH',
  ...
  {
    id: 'book2-unit11-video2',
    bookId: '2',
    unitId: '11',
    title: 'ESL Game - Rooms of the House hidden picture',
  ...
  {
    id: 'book2-unit11-video3',
    bookId: '2',
    unitId: '11',
    title: "Let's Build A House - MAPLE LEAF 1",
  ...
  {
    id: 'book2-unit11-video4',
    bookId: '2',
    unitId: '11',
    title: "Let's Build A House - MAPLE LEAF 2",
...
export const book2Unit11GameResources: TeacherResource[] = [
  {
    id: 'book2-unit11-game1',
    bookId: '2',
    unitId: '11',
    title: 'WORDWALL - ROOMS IN THE HOUSE',
  ...
  {
    id: 'book2-unit11-game2',
    bookId: '2',
    unitId: '11',
    title: 'WORDWALL - ROOMS IN THE HOUSE - BATHROOM',
  ...
  {
    id: 'book2-unit11-game3',
    bookId: '2',
    unitId: '11',
    title: 'WORDWALL - ROOMS IN THE HOUSE - BEDROOM',
  ...
  {
    id: 'book2-unit11-game4',
    bookId: '2',
    unitId: '11',
    title: 'WORDWALL - ROOMS IN THE HOUSE - KITCHEN',
  ...
  {
    id: 'book2-unit11-game5',
    bookId: '2',
    unitId: '11',
    title: 'WORDWALL - ROOMS IN THE HOUSE - LIVING ROOM',
  ...
  {
    id: 'book2-unit11-game6',
    bookId: '2',
    unitId: '11',
    title: 'WORDWALL - THINGS IN THE HOUSE',
  ...
  {
    id: 'book2-unit11-game7',
    bookId: '2',
    unitId: '11',
    title: 'WORDWALL - ROOMS AND THINGS IN THE HOUSE',
  ...
  {
    id: 'book2-unit11-game8',
    bookId: '2',
    unitId: '11',
    title: 'ABCYA - MAKE A HOUSE',
