// Implementation file for Book 0b Unit 8

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0b-unit8-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 8
const vocabularyLessonPlan: LessonPlan = {
  id: `book0b-unit8-vocabulary-lesson`,
  title: `VISUAL 0B Unit 8 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0b-unit8-activities-lesson`,
  title: `VISUAL 0B Unit 8 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0bUnit8LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0bUnit8Resources = (): TeacherResource[] => resources;
