...
export const book2Unit13VideoResources: TeacherResource[] = [
  {
    ...
    bookId: '2',
    unitId: unitNumber,
    title: `${BOOK2_TITLE} - UNIT ${unitNumber} - ${unitTitle} - What Are You Doing? Present Continuous Song`,
    description: 'Maple Leaf Learning song about present continuous activities and actions.',
    resourceType: 'video',
    provider: 'YouTube',
  ...
  },
  {
    ...
    bookId: '2',
    unitId: unitNumber,
    title: `${BOOK2_TITLE} - UNIT ${unitNumber} - ${unitTitle} - What Are You Doing Now? Present Continuous Tense`,
    description: 'Interactive lesson on present continuous tense with real-life examples.',
    resourceType: 'video',
    provider: 'YouTube',
  ...
  },
  {
    ...
    bookId: '2',
    unitId: unitNumber,
    title: `${BOOK2_TITLE} - UNIT ${unitNumber} - ${unitTitle} - Present Continuous - Active Kids`,
    description: 'Fun video showing kids performing various activities using present continuous tense.',
    resourceType: 'video',
    provider: 'YouTube',
