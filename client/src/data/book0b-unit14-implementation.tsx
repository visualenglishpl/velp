// Implementation file for Book 0b Unit 14

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0b-unit14-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 14
const vocabularyLessonPlan: LessonPlan = {
  id: `book0b-unit14-vocabulary-lesson`,
  title: `VISUAL 0B Unit 14 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0b-unit14-activities-lesson`,
  title: `VISUAL 0B Unit 14 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0bUnit14LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0bUnit14Resources = (): TeacherResource[] => resources;
