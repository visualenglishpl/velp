// Implementation file for Book 0a Unit 13

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0a-unit13-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 13
const vocabularyLessonPlan: LessonPlan = {
  id: `book0a-unit13-vocabulary-lesson`,
  title: `VISUAL 0A Unit 13 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0a-unit13-activities-lesson`,
  title: `VISUAL 0A Unit 13 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0aUnit13LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0aUnit13Resources = (): TeacherResource[] => resources;
