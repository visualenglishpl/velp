// Implementation file for Book 0c Unit 15

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0c-unit15-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 15
const vocabularyLessonPlan: LessonPlan = {
  id: `book0c-unit15-vocabulary-lesson`,
  title: `VISUAL 0C Unit 15 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0c-unit15-activities-lesson`,
  title: `VISUAL 0C Unit 15 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0cUnit15LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0cUnit15Resources = (): TeacherResource[] => resources;
