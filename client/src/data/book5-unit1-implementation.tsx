// This file imports and exports the resources and lesson plans for Book 5, Unit 1

import { book5Unit1Resources, schoolSystemsLessonPlan, schoolSubjectsActivitiesLessonPlan } from './book5-unit1-resources';
...
export const getBook5Unit1LessonPlans = (): LessonPlan[] => {
  return [
    schoolSystemsLessonPlan,
    schoolSubjectsActivitiesLessonPlan
  ];
};

// Function to get resources for this unit
export const getBook5Unit1Resources = (bookId: string, unitId: string): TeacherResource[] => {
  return book5Unit1Resources.map(resource => ({
    id: `book5-unit1-${resource.title.toLowerCase().replace(/\s+/g, '-')}`,
    bookId,
    unitId,
    ...resource
  }));
...
export const unitResources = book5Unit1Resources;
