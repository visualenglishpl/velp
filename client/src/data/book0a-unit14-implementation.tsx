// Implementation file for Book 0a Unit 14

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0a-unit14-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 14
const vocabularyLessonPlan: LessonPlan = {
  id: `book0a-unit14-vocabulary-lesson`,
  title: `VISUAL 0A Unit 14 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0a-unit14-activities-lesson`,
  title: `VISUAL 0A Unit 14 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0aUnit14LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0aUnit14Resources = (): TeacherResource[] => resources;
