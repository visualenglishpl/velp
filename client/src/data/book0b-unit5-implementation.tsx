// Implementation file for Book 0b Unit 5

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0b-unit5-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 5
const vocabularyLessonPlan: LessonPlan = {
  id: `book0b-unit5-vocabulary-lesson`,
  title: `VISUAL 0B Unit 5 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0b-unit5-activities-lesson`,
  title: `VISUAL 0B Unit 5 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0bUnit5LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0bUnit5Resources = (): TeacherResource[] => resources;
