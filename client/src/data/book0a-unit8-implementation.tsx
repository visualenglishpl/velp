// Implementation file for Book 0a Unit 8

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0a-unit8-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 8
const vocabularyLessonPlan: LessonPlan = {
  id: `book0a-unit8-vocabulary-lesson`,
  title: `VISUAL 0A Unit 8 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0a-unit8-activities-lesson`,
  title: `VISUAL 0A Unit 8 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0aUnit8LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0aUnit8Resources = (): TeacherResource[] => resources;
