// Implementation file for Book 0a Unit 2

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0a-unit2-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 2
const vocabularyLessonPlan: LessonPlan = {
  id: `book0a-unit2-vocabulary-lesson`,
  title: `VISUAL 0A Unit 2 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0a-unit2-activities-lesson`,
  title: `VISUAL 0A Unit 2 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0aUnit2LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0aUnit2Resources = (): TeacherResource[] => resources;
