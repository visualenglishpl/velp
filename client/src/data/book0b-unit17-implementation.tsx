// Implementation file for Book 0b Unit 17

import { TeacherResource } from '@/components/TeacherResources';
import { resources } from './book0b-unit17-resources';

import { LessonPlan } from '@/components/LessonPlanTemplate';

// Lesson plans for Unit 17
const vocabularyLessonPlan: LessonPlan = {
  id: `book0b-unit17-vocabulary-lesson`,
  title: `VISUAL 0B Unit 17 - Vocabulary Development`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
const activitiesLessonPlan: LessonPlan = {
  id: `book0b-unit17-activities-lesson`,
  title: `VISUAL 0B Unit 17 - Interactive Activities`,
  duration: '45 minutes',
  level: 'Beginner',
  objectives: [
...
export const getBook0bUnit17LessonPlans = () => lessonPlans;

// Function to get resources for this unit
export const getBook0bUnit17Resources = (): TeacherResource[] => resources;
