      ...
      <main className="pb-6">
        ...
        <section className="bg-gray-50 py-6" id="about-cta">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <Link href="/books">
              <span className="inline-flex items-center px-5 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none cursor-pointer">
