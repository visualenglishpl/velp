...
export function getHardcodedQuestionAnswers(bookId: string, unitId: string): QuestionAnswerEntry[] {
  ...
  if (bookId === 'book1' && unitId === 'unit2') {
    ...
    return [
      ...
      // Section 8 - Sharpener (pattern M) - REMOVED due to incorrect matching, use client pattern visual detection instead
      
      // Section 10 - Ruler (pattern N) - REMOVED due to incorrect matching, use client pattern visual detection instead
      
      // Section 11 - Pencil Case (pattern N) - REMOVED due to incorrect matching, use client pattern visual detection instead
      
      // Section 12 - Scissors (pattern N) - Complete accurate mapping based on provided documentation
      {
        filename: "12 N A What are They – They are Scissors.gif",
        codePattern: "12 N A",
        question: "What are they?",
