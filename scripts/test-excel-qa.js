// Simple script to test Excel processing
const fs = require('fs');
const path = require('path');
const excelProcessor = require('../server/excel-processor');
...
try {
  const mapping = excelProcessor.processExcelAndGenerateTS(excelPath, outputPath);
